...
function Upload() {
  ...
  const fetchData = async () => {
    try {
      ...
      const data = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/main/calendar/${formattedDate}/`, {
        method: "GET",
        headers: {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/main/imageupload/`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDelete = (menuId, date) => {
    ...
    fetch(`${process.env.REACT_APP_BACKEND_URL}/api/main/menu/${date}/${menuId}/`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
